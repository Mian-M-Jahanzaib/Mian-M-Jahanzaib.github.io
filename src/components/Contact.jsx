...
const Contact = () => {
  ...
  return (
    <section
      className="py-12 md:py-16 bg-primary relative overflow-hidden"
      id="contact"
    >
      {/* Background glow effect for premium depth */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-1/2 bg-white/5 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-10 h-10 text-white/50 group-hover:text-white group-hover:scale-110 transition-all duration-500 mb-2"
            >
              <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
            </svg>
            <span className="text-xs md:text-sm font-bold tracking-[0.2em] uppercase text-white/70 group-hover:text-white transition-colors duration-500">
              Email
            </span>
